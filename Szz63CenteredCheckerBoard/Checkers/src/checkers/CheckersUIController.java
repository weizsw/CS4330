...
public class CheckersUIController implements Initializable {
    ...
    private double Hmargin = 0;
    private double Vmargin = 0;
...
//        stackPane.getChildren().add(checkerBoard.build());
        ...
        x = scene.getWidth();
        y = scene.getHeight()- menuBar.getHeight();
       
        if(x<y){
           
            boardWidth = x;
            boardHeight = boardWidth;
            Vmargin = (y - boardHeight)/2 ;
            Hmargin = 0;
        }
        else{
           boardHeight = y ;
           boardWidth = boardHeight;
           Hmargin = (x - boardWidth) / 2 ;
           Vmargin =0;
        }
        ...
        pane = checkerBoard.build();
        StackPane.setMargin(pane, new Insets(Vmargin,Hmargin,Vmargin,Hmargin));
